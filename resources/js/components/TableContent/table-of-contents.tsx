                    ...
                    {headings.map((heading) => (
                        <li key={heading.id}>
                            <button
                                ...
                                className={cn('block w-full text-left text-sm text-muted-foreground transition-colors hover:text-foreground', {
                                    'font-medium text-primary underline underline-offset-4': activeId === heading.id,
                                })}
                            >
                                {heading.text}
                            </button>
