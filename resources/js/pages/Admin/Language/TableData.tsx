                                ...
                                <TableCellActions>
                                    {item.deleted_at ? (
                                        <RecoverItem
                                            ...
                                            recoverPath={`/admin/languages/${item.id}/recover`}
                                            permission="user update"
                                        />
                                    ) : (
                                        <>
                                            {/* Edit Dialog */}
                                            <EditItemButton url={`/admin/languages/${item.id}/edit`} permission="language update" />

                                            {/* View Dialog */}
                                            <ViewItemButton url={`/admin/languages/${item.id}`} permission="language view" />

                                            {/* Delete Item */}
                                            <DeleteItemButton deletePath="/admin/languages/" id={item.id} permission="language delete" />
                                        </>
                                    )}
                                </TableCellActions>
                                <TableCell>
                                    <TableCellAvatar
                                        ...
                                        alt={item.name}
                                        image={`/assets/images/languages/thumb/${item.image}`}
                                    />
                                </TableCell>
