            ...
            <div className="table-data-container">
                <Table>
                    <TableHeader className="table-header">
                        <TableRow>
                            <TableHeadWithSort field="read_date" label="Read Date" />
                            ...
                            <TableHeadWithSort field="reads" label="Reads" />
                        </TableRow>
                    </TableHeader>
                    ...
                    <TableBody className="table-body rounded-md">
                        {tableData?.data?.map((row: any) => (
                            <TableRow className="table-row" key={row.id}>
                                <TableCellDate value={row.read_date} showTime={false} />
