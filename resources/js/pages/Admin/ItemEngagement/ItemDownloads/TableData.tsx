            ...
            <div className="table-data-container">
                <Table>
                    <TableHeader className="table-header">
                        <TableRow>
                            <TableHeadWithSort field="download_date" label="Download Date" />
                            ...
                            <TableHeadWithSort field="downloads" label="Downloads" />
                        </TableRow>
                    </TableHeader>
                    ...
                    <TableBody className="table-body rounded-md">
                        {tableData?.data?.map((row: any) => (
                            <TableRow className="table-row" key={row.id}>
                                <TableCellDate value={row.download_date} showTime={false} />
                                ...
                                <TableCellText value={row.downloads} />
                            </TableRow>
                        ))}
                    </TableBody>
                </Table>
