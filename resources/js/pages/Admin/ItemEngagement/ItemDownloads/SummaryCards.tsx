...
const SummaryCards = () => {
    ...
    const stats = [
        ...
        {
            label: 'Desktop',
            value: summary?.desktop_downloads ?? 0,
            percent: getPercentage(summary?.desktop_downloads ?? 0),
        ...
        {
            label: 'Mobile',
            value: summary?.mobile_downloads ?? 0,
            percent: getPercentage(summary?.mobile_downloads ?? 0),
        ...
        },
        {
            ...
            value: summary?.today_downloads ?? 0,
