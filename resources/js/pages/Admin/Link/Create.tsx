                    ...
                    <div className="form-field-container">
                        <div className="md:col-span-2">
                            <FormField
                                ...
                                name="link"
                                label="Link"
                                description="Enter full URL (use <b>#</b> if none)"
                                value={data.link}
                        ...
                        {types?.length > 0 && (
                            <FormCombobox
                                name="type_code"
                                label="Type"
                                options={types.map((item: any) => ({ value: item.code, label: item.name }))}
                        ...
                        <div className="col-span-2">
                            ...
                            {editData?.image && (
                                <UploadedImage label="Uploaded Image" images={editData?.image} basePath="/assets/images/links/thumb/" />
                            )}
                        </div>
                    </div>
                )}
