                                ...
                                <TableCellActions>
                                    {item.deleted_at ? (
                                        <RecoverItem
                                            ...
                                            recoverPath={`/admin/locations/${item.id}/recover`}
                                            permission="user update"
                                        />
                                    ) : (
                                        <>
                                            {/* Edit Dialog */}
                                            <EditItemButton url={`/admin/locations/${item.id}/edit`} permission="location update" />

                                            {/* View Dialog */}
                                            <ViewItemButton url={`/admin/locations/${item.id}`} permission="location view" />

                                            {/* Delete Item */}
                                            <DeleteItemButton deletePath="/admin/locations/" id={item.id} permission="location delete" />
                                        </>
                                    )}
                                </TableCellActions>
                                <TableCell>
