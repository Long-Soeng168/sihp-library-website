                            ...
                            <TableRow className="table-row" key={item.id}>
                                ...
                                <TableCellActions>
                                    {item.deleted_at ? (
                                        ...
                                        <>
                                            {/* Edit Dialog */}
                                            <EditItemButton url={`/admin/libraries/${item.id}/edit`} permission="library update" />

                                            {/* View Dialog */}
                                            <ViewItemButton url={`/admin/libraries/${item.id}`} permission="library view" />

                                            {/* Delete Item */}
                                            <DeleteItemButton deletePath="/admin/libraries/" id={item.id} permission="library delete" />
                                        </>
                                    )}
                                </TableCellActions>
                                <TableCell>
                                    <TableCellAvatar
                                        ...
                                        alt={item.name}
                                        image={`/assets/images/libraries/thumb/${item.image}`}
                                    />
                                </TableCell>
