                                ...
                                <TableCellActions>
                                    {item.deleted_at ? (
                                        <RecoverItem
                                            ...
                                            recoverPath={`/admin/type-groups/${item.id}/recover`}
                                            permission="user update"
                                        />
                                    ) : (
                                        <>
                                            {/* Edit Dialog */}
                                            <EditItemButton url={`/admin/type-groups/${item.id}/edit`} permission="type_group update" />

                                            {/* View Dialog */}
                                            <ViewItemButton url={`/admin/type-groups/${item.id}`} permission="type_group view" />

                                            {/* Delete Item */}
                                            <DeleteItemButton deletePath="/admin/type-groups/" id={item.id} permission="type_group delete" />
                                        </>
                                    )}
                                </TableCellActions>
                                <TableCell>
                                    <TableCellAvatar
                                        ...
                                        alt={item.name}
                                        image={`/assets/images/type_groups/thumb/${item.image}`}
                                    />
                                </TableCell>
