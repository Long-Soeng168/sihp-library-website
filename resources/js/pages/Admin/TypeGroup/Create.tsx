...
export default function Create({ editData, readOnly }: { editData?: any; readOnly?: boolean }) {
    ...
    const onSubmit = (e: React.FormEvent) => {
        ...
        if (editData?.id) {
            post(`/admin/type-groups/${editData.id}/update`, {
                onSuccess: (page: any) => {
                    setFiles(null);
    ...
    const breadcrumbs: BreadcrumbItem[] = [
        ...
        { title: 'Groups', href: '/admin/type-groups' },
                ...
                {inputLanguage == 'khmer' ? (
                    ...
                    <div className="form-field-container">
                        <FormField
                            ...
                            error={errors.code}
                            description={editData?.types_count > 0 ? `Group has types — cannot update code.` : `Example: my-item-code`}
                        />
                        ...
                        <div className="col-span-2">
                            ...
                            {editData?.image && (
                                <UploadedImage label="Uploaded Image" images={editData?.image} basePath="/assets/images/type_groups/thumb/" />
                            )}
                        </div>
                    </div>
                )}
