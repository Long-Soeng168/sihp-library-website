...
import { CircleFadingArrowUpIcon, InfoIcon, MousePointerClickIcon } from 'lucide-react';
                ...
                <DialogHeader>
                    ...
                    <div>
                        <Alert className="rounded-none border-0 border-l-4 border-l-blue-500 bg-blue-500/10 dark:bg-blue-500/20">
                            ...
                            <AlertTitle><b>Double-click</b> a record to view its subcategory.</AlertTitle>
                        </Alert>
                    </div>
                </DialogHeader>
            </DialogContent>
