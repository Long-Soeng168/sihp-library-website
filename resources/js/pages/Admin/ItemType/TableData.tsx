                            ...
                            <TableRow className="table-row" key={item.id}>
                                ...
                                <TableCellActions>
                                    {item.deleted_at ? (
                                        ...
                                        <>
                                            {/* Edit Dialog */}
                                            <EditItemButton url={`/admin/item-types/${item.id}/edit`} permission="item_type update" />

                                            {/* View Dialog */}
                                            <ViewItemButton url={`/admin/item-types/${item.id}`} permission="item_type view" />

                                            {/* Delete Item */}
                                            <DeleteItemButton deletePath="/admin/item-types/" id={item.id} permission="item_type delete" />
                                        </>
                                    )}
                                </TableCellActions>
                                <TableCell>
